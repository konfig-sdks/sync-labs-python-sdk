...
class RequiredLipSyncInitial(TypedDict):
...
class OptionalLipSyncInitial(TypedDict, total=False):
    # A URL which can be used to download the video.
    url: str

class LipSyncInitial(RequiredLipSyncInitial, OptionalLipSyncInitial):
    pass
