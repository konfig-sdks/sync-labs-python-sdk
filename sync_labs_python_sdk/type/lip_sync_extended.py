...
class RequiredLipSyncExtended(TypedDict):
...
class OptionalLipSyncExtended(TypedDict, total=False):
    # A URL which can be used to download the video.
    url: str

class LipSyncExtended(RequiredLipSyncExtended, OptionalLipSyncExtended):
    pass
