...
class RequiredCreateVideoDto(TypedDict):
...
class OptionalCreateVideoDto(TypedDict, total=False):
...
class CreateVideoDto(RequiredCreateVideoDto, OptionalCreateVideoDto):
    pass
