...
class LipSyncInitial(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "original_video_url", "original_audio_url", "status", "synergize", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "original_video_url", "original_audio_url", "status", "synergize", "url", ], str]):
