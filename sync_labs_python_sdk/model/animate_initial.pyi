...
class AnimateInitial(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "transcript_url", "status", "video_url", "audio_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "transcript_url", "status", "video_url", "audio_url", ], str]):
